...
// export const commandSize = await loadCommands()
// let commandSize = 0;
// export async function initializeCommands() {
//     commandSize = await loadCommands();
//     return commandSize;
// }

// export function getCommandSize() {
//     return commandSize;
// }
...
export default async function handleCommand(sock, msg) {
    try {
        ...
        const isAllowed = config.allowedUsers.includes(sender) || isOwner || msg.key.fromMe || command.isPublic;
        ...
        await sock.sendMessage(msg.key.remoteJid, {text: "Command error--:" + err.stack})
    }
}
