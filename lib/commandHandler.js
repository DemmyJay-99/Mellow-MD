...
const prefix = process.env.PREFIX || config.prefix; // or whatever you prefer
// let ownerNumber = process.env.OWNER_NUMBER || config.ownerNumber;
...
export default async function handleCommand(sock, msg) {
    try {
        ...
        await sock.sendMessage(msg.key.remoteJid, {
            react: {
                text: `${process.env.REACT_EMOJI || config.reactEmoji}`,
                key: msg.key,
            },
        });
